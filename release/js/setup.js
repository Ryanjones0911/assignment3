...
function setup() {
    ...
    const floorDiff = new THREE.TextureLoader().load('images/rosewood_veneer1_diff.jpg');
    // Ambient occlusion map
    const floorAo = new THREE.TextureLoader().load('images/rosewood_veneer1_ao.jpg');
    // Displacement map
    const floorDisp = new THREE.TextureLoader().load('images/rosewood_veneer1_disp.png');
    // Normal map
    const floorNorm = new THREE.TextureLoader().load('images/rosewood_veneer1_nor.exr');
    // Roughness map
    const floorRoughness = new THREE.TextureLoader().load('images/rosewood_veneer1_rough.exr');
