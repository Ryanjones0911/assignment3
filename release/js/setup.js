...
function setup() {
    ...
    //this doesn't look good but I am BEYOND out of time
    const TextureLoader = new THREE.TextureLoader();
    TextureLoader.load('images/skybox.jpeg', (texture) => {
        texture.mapping = THREE.EquirectangularReflectionMapping; // this just wraps the image around to make a pseudo sphere
    ...
    const floorDiff = new THREE.TextureLoader().load('images/Grass_001_COLOR.jpg');
    // Ambient occlusion map
    const floorAo = new THREE.TextureLoader().load('images/Grass_001_OCC.jpg');
    // Displacement map
    const floorDisp = new THREE.TextureLoader().load('images/Grass_001_DISP.png');
    // Normal map
    const floorNorm = new THREE.TextureLoader().load('images/Grass_001_NORM.jpg');
    // Roughness map
    const floorRoughness = new THREE.TextureLoader().load('images/Grass_001_ROUGH.jpg');
